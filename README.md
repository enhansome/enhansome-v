...
* [text\_editor](https://github.com/vlang/v/blob/master/examples/term.ui/text_editor.v) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - Small text editor from the official V examples.
...
* [flappylearning-v](https://github.com/vlang/v/tree/master/examples/flappylearning) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - A simple flappy learning demo in v.
...
* [v](https://github.com/vlang/v) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - The language V itself. Simple, fast, safe, compiled language for developing maintainable software.
...
* [Vinix](https://github.com/vlang/vinix) ⭐ 2,331 | 🐛 48 | 🌐 V | 📅 2026-09-23 - Small and simple OS in V. Runs bash.
...
* [Gitly](https://github.com/vlang/gitly) ⭐ 1,485 | 🐛 32 | 🌐 V | 📅 2026-09-09 - A light and fast SCM alternative to GitHub/GitLab written in V.
...
* [eventbus](https://github.com/vlang/v/tree/master/vlib/eventbus) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - A simple event bus system for V.
...
* [netaddr](https://github.com/gechandesu/netaddr) ⭐ 6 | 🐛 0 | 🌐 V | 📅 2026-09-23 - IPv4, IPv6 and MAC (EUI-48, EUI-64) addresses manipulation library.
...
* [clipboard](https://github.com/vlang/v/tree/master/vlib/clipboard) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - V module for interacting with the OS clipboard. Fully cross-platform.
...
* [vig](https://github.com/nsauzede/vig) ⭐ 55 | 🐛 5 | 🌐 C | 📅 2024-02-19 - Bindings for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,337 | 🐛 1,222 | 🌐 C++ | 📅 2026-09-23 GUI toolkit.
...
* [v-rsa](https://github.com/deatil/v-rsa) ⭐ 1 | 🐛 0 | 🌐 V | 📅 2026-09-22 - A RSA library for vlang.
...
* [veb](https://github.com/vlang/v/tree/master/vlib/veb) ⭐ 37,908 | 🐛 163 | 🌐 V | 📅 2026-09-23 - V's built-in web framework.
...
* [v-jwt](https://github.com/deatil/v-jwt) ⭐ 2 | 🐛 0 | 🌐 V | 📅 2026-09-23 - A JWT (JSON Web Token) library for vlang.
...
* [vscode-vlang](https://github.com/vlang/vscode-vlang) ⭐ 408 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-23 - V Language extension for Visual Studio Code.
