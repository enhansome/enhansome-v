...
* [text\_editor](https://github.com/vlang/v/blob/master/examples/term.ui/text_editor.v) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - Small text editor from the official V examples.
...
* [flappylearning-v](https://github.com/vlang/v/tree/master/examples/flappylearning) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - A simple flappy learning demo in v.
...
* [v](https://github.com/vlang/v) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - The language V itself. Simple, fast, safe, compiled language for developing maintainable software.
...
* [boj-server](https://github.com/hyperpolymath/boj-server) ⭐ 3 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-03 - Unified developer tool server using V for the network adapter layer. Exposes REST (port 7700), gRPC (7701), and GraphQL (7702) from a single V codebase. 18 capability cartridges loaded via Zig FFI with Idris2-verified interfaces.
...
* [eventbus](https://github.com/vlang/v/tree/master/vlib/eventbus) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - A simple event bus system for V.
...
* [V Earcut](https://github.com/Larpon/earcut) ⭐ 15 | 🐛 0 | 🌐 V | 📅 2025-12-18 - fast (real-time) polygon triangulation library based on [mapbox/Earcut](https://github.com/mapbox/earcut) ⭐ 2,585 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-02 to handle holes, twisted polygons, degeneracies and self-intersections.
...
* [clipboard](https://github.com/vlang/v/tree/master/vlib/clipboard) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - V module for interacting with the OS clipboard. Fully cross-platform.
...
* [vig](https://github.com/nsauzede/vig) ⭐ 54 | 🐛 5 | 🌐 C | 📅 2024-02-19 - Bindings for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,045 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-03 GUI toolkit.
...
* [v-rsa](https://github.com/deatil/v-rsa) ⭐ 0 | 🐛 0 | 🌐 V | 📅 2026-09-03 - A RSA library for vlang.
...
* [veb](https://github.com/vlang/v/tree/master/vlib/veb) ⭐ 37,817 | 🐛 90 | 🌐 V | 📅 2026-09-03 - V's built-in web framework.
