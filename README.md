...
* [httest](https://github.com/gechandesu/httest) ⭐ 3 | 🐛 0 | 🌐 V | 📅 2026-09-02 - A CGI-enabled HTTP test server for mocking backends, inspecting requests and simulating latency and failures.
...
* [text\_editor](https://github.com/vlang/v/blob/master/examples/term.ui/text_editor.v) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - Small text editor from the official V examples.
...
* [flappylearning-v](https://github.com/vlang/v/tree/master/examples/flappylearning) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - A simple flappy learning demo in v.
...
* [v](https://github.com/vlang/v) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - The language V itself. Simple, fast, safe, compiled language for developing maintainable software.
...
* [Vinix](https://github.com/vlang/vinix) ⭐ 2,165 | 🐛 24 | 🌐 V | 📅 2026-06-18 - Small and simple OS in V. Runs bash.
...
* [vpm](https://github.com/vlang/vpm) ⭐ 134 | 🐛 34 | 🌐 V | 📅 2026-08-31 - The V language package management tool written in V.
...
* [boj-server](https://github.com/hyperpolymath/boj-server) ⭐ 3 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-02 - Unified developer tool server using V for the network adapter layer. Exposes REST (port 7700), gRPC (7701), and GraphQL (7702) from a single V codebase. 18 capability cartridges loaded via Zig FFI with Idris2-verified interfaces.
...
* [Gitly](https://github.com/vlang/gitly) ⭐ 1,478 | 🐛 32 | 🌐 V | 📅 2026-07-11 - A light and fast SCM alternative to GitHub/GitLab written in V.
...
* [eventbus](https://github.com/vlang/v/tree/master/vlib/eventbus) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - A simple event bus system for V.
...
* [V Earcut](https://github.com/Larpon/earcut) ⭐ 15 | 🐛 0 | 🌐 V | 📅 2025-12-18 - fast (real-time) polygon triangulation library based on [mapbox/Earcut](https://github.com/mapbox/earcut) ⭐ 2,583 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-02 to handle holes, twisted polygons, degeneracies and self-intersections.
...
* [clipboard](https://github.com/vlang/v/tree/master/vlib/clipboard) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - V module for interacting with the OS clipboard. Fully cross-platform.
...
* [vig](https://github.com/nsauzede/vig) ⭐ 54 | 🐛 5 | 🌐 C | 📅 2024-02-19 - Bindings for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,017 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-02 GUI toolkit.
...
* [v-rsa](https://github.com/deatil/v-rsa) ⭐ 0 | 🐛 0 | 🌐 V | 📅 2026-09-02 - A RSA library for vlang.
...
* [veb](https://github.com/vlang/v/tree/master/vlib/veb) ⭐ 37,816 | 🐛 96 | 🌐 V | 📅 2026-09-02 - V's built-in web framework.
...
* [setup-v](https://github.com/vlang/setup-v) ⭐ 33 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 - GitHub Action to install and use V in your workflow. Available on the [marketplace](https://github.com/marketplace/actions/setup-vlang).
