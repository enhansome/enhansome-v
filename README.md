...
* [text\_editor](https://github.com/vlang/v/blob/master/examples/term.ui/text_editor.v) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - Small text editor from the official V examples.
...
* [flappylearning-v](https://github.com/vlang/v/tree/master/examples/flappylearning) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - A simple flappy learning demo in v.
...
* [v](https://github.com/vlang/v) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - The language V itself. Simple, fast, safe, compiled language for developing maintainable software.
...
* [boj-server](https://github.com/hyperpolymath/boj-server) ⭐ 3 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-26 - Unified developer tool server using V for the network adapter layer. Exposes REST (port 7700), gRPC (7701), and GraphQL (7702) from a single V codebase. 18 capability cartridges loaded via Zig FFI with Idris2-verified interfaces.
...
* [eventbus](https://github.com/vlang/v/tree/master/vlib/eventbus) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - A simple event bus system for V.
...
* [clipboard](https://github.com/vlang/v/tree/master/vlib/clipboard) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - V module for interacting with the OS clipboard. Fully cross-platform.
...
* [vig](https://github.com/nsauzede/vig) ⭐ 54 | 🐛 5 | 🌐 C | 📅 2024-02-19 - Bindings for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 75,880 | 🐛 1,237 | 🌐 C++ | 📅 2026-08-23 GUI toolkit.
...
* [v-rsa](https://github.com/deatil/v-rsa) ⭐ 0 | 🐛 0 | 🌐 V | 📅 2026-08-26 - A RSA library for vlang.
...
* [veb](https://github.com/vlang/v/tree/master/vlib/veb) ⭐ 37,803 | 🐛 101 | 🌐 V | 📅 2026-08-26 - V's built-in web framework.
...
* [v-jwt](https://github.com/deatil/v-jwt) ⭐ 2 | 🐛 0 | 🌐 V | 📅 2026-08-25 - A JWT (JSON Web Token) library for vlang.
